...
between-zone OD pairs in the study area, `r round(nrow(l) / n_flow_region * 100)`% are represented as
...
within-zone travel (accounting for `r round(sum(cents$All) / sum(zones$All) * 100)`% of commutes) and people with no fixed place of work.
