...
levels(dfsp$scenario)[1:6] <- c("Total no. commuters", "Cyclists in Ebikes", "Cyclists in Go Dutch",  "Cyclists in Government Target", "Cyclists in Near Market", "Cyclists in Gender Equality", "Cyclists in Census 2011")
