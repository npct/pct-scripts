...
The **Route Network (LSOA)** is built from all between-zone LSOA fast routes (including any that start *or* end in `r get_pretty_region_name(region)`) that have a fast route distance <20km. For more details please see User Manual C.
