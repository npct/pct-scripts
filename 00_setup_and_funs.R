...
init_outputs_national <- function(purpose, geography){
  ...
  if(purpose == "school") {
    assign("z_all_public", readRDS(file.path(path_outputs_national, purpose_public, geography,  "z_all.Rds")), envir = .GlobalEnv)
    assign("d_all", readRDS(file.path(path_outputs_national, purpose, geography,  "d_all.Rds")), envir = .GlobalEnv)
    assign("d_all_public", readRDS(file.path(path_outputs_national, purpose_public, geography,  "d_all.Rds")), envir = .GlobalEnv)
