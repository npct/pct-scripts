...
region_shape <- spTransform(region_shape, CRSobj = proj4string(cents))
...
l$base_sic <- l$base_slc - l$Bicycle
...
l$govtarget_slc <-l$All * (l$clc + l$npred) # may be more that 1
...
l$Other <- l$Other + l$Taxi
l$Taxi <- l$Light_rail <- l$Train <- NULL # remove aggregated categories
...
# Data preprocessing
l
# Remove private/superfluous variables
l$Male <- l$Female <- l$From_home <- NULL
