...
levels(dfsp$scenario)[1:7] <- c("Total no. commuters", "Cyclists in Ebikes", "Cyclists in Go Dutch","Cyclists in Government Target", "Cyclists in Near Market", "Cyclists in Gender Equality", "Cyclists in Census 2011")
...
| Near Market | `r paste(sprintf('%.1f', (b <- round(100 * sum(z$nearmkt_slc) / sum(z$all) , 1))), '%')` | `r paste(sprintf('%.1f', (f <- round(100 * sum(z$nearmkt_slw) / sum(z$all) , 1))), '%')`|`r paste(sprintf('%.1f', (cd <- round(100 * sum(z$nearmkt_sld) / sum(z$all) , 1))), '%')` | `r paste(sprintf('%.1f', (100 - b - f - cd)), '%')` |
...
| Near Market |	'No Cyclists' |  `r (sprintf('%.2f', round(sum(z$nearmkt_sldeath_heat) , 2)))` | `r (sprintf('%.2f', round(sum(z$nearmkt_slvalue_heat) / 1000000  , 2)))` | `r (round( sum(z$nearmkt_slco2) / 1000))` | 
