...
z_codebook <- read_csv(file.path(path_outputs_regional_R, purpose, geography, region,  "alltrips_codebooks_temp/z_codebook.csv"))
c_codebook <- read_csv(file.path(path_outputs_regional_R, purpose, geography, region,  "alltrips_codebooks_temp/c_codebook.csv"))
od_l_rf_codebook <- read_csv(file.path(path_outputs_regional_R, purpose, geography, region,  "alltrips_codebooks_temp/od_l_rf_codebook.csv"))
rq_codebook <- read_csv(file.path(path_outputs_regional_R, purpose, geography, region,  "alltrips_codebooks_temp/rq_codebook.csv"))
rnet_codebook <- read_csv(file.path(path_outputs_regional_R, purpose, geography, region,  "alltrips_codebooks_temp/rnet_codebook.csv"))
