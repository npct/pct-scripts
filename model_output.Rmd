...
| Scenario | Comparison	| Change in deaths/year  | Value of change ( `r htmltools::HTML('&pound;')` millions)  | Change in tonnes CO2e/year |
| -------- |:----------:|:-----------------: |:----------:| :---------------:|
...
| Gender Equity |	'No Cyclists' |  `r (round(sum(zones$ebike_sldeath_heat) , 2))` | `r (round(sum(zones$ebike_slvalue_heat) / 1000000  , 2))` | `r (round( sum(zones$ebike_slco2) / 1000))` |
