...
### Key information for `r get_pretty_region_name(region)`, MSOA geography
...
Table 1 summarises the proportion of commuters walking, driving and using other modes under each scenario in `r get_pretty_region_name(region)`, based on aggregating across all residents in all the MSOA zones.
