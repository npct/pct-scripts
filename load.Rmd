...
if(file.exists(file.path(pct_data, region, "rf.Rds")) &
   file.exists(file.path(pct_data, region, "rq.Rds"))){
  rf <- readRDS(file.path(pct_data, region, "rf.Rds")) # if you've loaded them
  rq <- readRDS(file.path(pct_data, region, "rq.Rds"))

} else {
  # see ?line2route from stplanSys.getenv('CYCLESTREET')r package
