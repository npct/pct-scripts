...
| Government Target (near market) | `r paste(sprintf('%.1f', (b <- round(100 * sum(z$nearmkt_slc) / sum(z$all) , 1))), '%')` | `r paste(sprintf('%.1f', (f <- round(100 * sum(z$nearmkt_slw) / sum(z$all) , 1))), '%')`|`r paste(sprintf('%.1f', (cd <- round(100 * sum(z$nearmkt_sld) / sum(z$all) , 1))), '%')` | `r paste(sprintf('%.1f', (100 - b - f - cd)), '%')` |
...
| Government Target (near market) |	'No Cyclists' |  `r (sprintf('%.2f', round(sum(z$nearmkt_sldeath_heat) , 2)))` | `r (sprintf('%.2f', round(sum(z$nearmkt_slvalue_heat) / 1000000  , 2)))` | `r (round( sum(z$nearmkt_slco2) / 1000))` | 
|  |	Census 2011 |  `r (sprintf('%.2f', round(sum(z$nearmkt_sideath_heat) , 2)))` | `r (sprintf('%.2f', round(sum(z$nearmkt_sivalue_heat) / 1000000  , 2)))` | `r (round( sum(z$nearmkt_sico2) / 1000))` |
